...
local function distanceCheck()
    ...
    if GetPedInVehicleSeat(vehicle, -1) ~= ped or vehClass == 13 or vehClass == 14 or vehClass == 15 or vehClass == 16 or
        vehClass == 17 or vehClass == 21 then
        sendToNui({
            type = "hide"
        })
        return
